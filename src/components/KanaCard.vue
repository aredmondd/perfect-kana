...
<template>
     <div class="flex gap-24 justify-between items-center">
        ...
        <div class="flex flex-col gap-6">
            <p v-if="!mutations.infinite" class="opacity-50 text-center">kana remaining: {{ practiceArray.length }}</p>
